<div class="impressum"><h1 style="margin-bottom: 0.5em;">Impressum</h1><div class="impressum__firmenname"><strong>Breitwieserhof GMBH</strong></div><div class="impressum__email" style="margin-top: 0.5em;"><a href="mailto:guenter.edelsbrunner@liwest.at">guenter.edelsbrunner@liwest.at</a></div><div class="impressum__telefon">0732 253032</div><div class="impressum__addresse" style="margin: 0.5em 0px; white-space: pre-wrap;">Brucknerstraße 38,
4020 Linz</div><div class="impressum__unternehmensgegenstand"><strong>Unternehmensgegenstand</strong>: Gasthof</div><div class="impressum__firmenbuchnummer"><strong>Firmenbuchnummer</strong>: 12345678</div><div class="impressum__firmenbuchgericht"><strong>Firmenbuchgericht</strong>: Handelsgericht Linz</div><div class="impressum__uid"><strong>UID-Nummer</strong>: ATU12345678</div><div class="impressum__aufsichtsbehoerde"><strong>Aufsichtsbehörde</strong>: BH Linz</div><div class="impressum__kammerzugehoerigkeiten"><strong>Mitglied folgender Kammern</strong>: WKO</div><div class="impressum__anwendbare-vorschriften"><strong>Anwendbare gewerbe- oder berufsrechtliche Vorschriften:</strong><ul><li class="impressum__anwendbare-vorschrift"><a href="http://www.ris.bka.gv.at">Österreichische Gewerbeordnung</a></li></ul></div><div class="impressum__flinkshop" style="font-size: 75%; margin-top: 1em;">Erstellt mit dem <a href="https://www.flinkshop.at">flinkshop</a> <a href="https://handbuch.flinkshop.at/impressum-generator">Impressum-Generator</a></div></div>

    Anbieter und Verantwortlicher
Breitwieserhof GMBH, Brucknerstraße 38, 4020 Linz

E-Mail-Adresse des Anbieters: MarcoHadzija@gmx.at

Arten der erhobenen Daten
Zu den personenbezogenen Daten, die diese Anwendung selbstständig oder durch Dritte verarbeitet, gehören: Vorname.
...
Personenbezogene Daten über den Nutzer werden erhoben, damit der Anbieter den Dienst erbringen und des Weiteren seinen gesetzlichen Verpflichtungen nachkommen, auf Durchsetzungsforderungen reagieren, seine Rechte und Interessen (oder die der Nutzer oder Dritter) schützen, böswillige oder betrügerische Aktivitäten aufdecken kann. Darüber hinaus werden Daten zu folgenden Zwecken erhoben: Plattform-Dienste und Hosting.
